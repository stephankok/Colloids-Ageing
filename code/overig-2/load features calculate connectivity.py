...
plt.figure()
plt.plot([i*5*60 for i in range(0,160)],particlesFoundList[:160])
plt.title("Tracked amount of particles")
...
#    list12.append(y[12])
#    list13.append(y[13])
xlist=[i*5*60 for i in range(0,160,2)]
plt.figure()
plt.scatter(xlist,list1, label = "1 bonds", c=colour[0], marker = filled_markers[0])
plt.scatter(xlist,list2, label = "2 bonds", c='r', marker = filled_markers[1])
...
plt.scatter(xlist,list6, label = "6 bonds", c=colour[5], marker = filled_markers[5])
#plt.scatter(xlist,list7, label = "7 neigbours", c='y', marker = filled_markers[6])
#plt.scatter(xlist,list8, label = "8 neigbours", c='b', marker = filled_markers[7])
#plt.scatter(xlist,list9, label = "9 neigbours", c='r', marker = filled_markers[8])
...
plt.legend(loc='center left', bbox_to_anchor=(0.80, 0.5))
