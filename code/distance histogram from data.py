...
FEATURESLOC = "E:\\Stephan Bachelorproject\\20160627_long_3045.mdb\\features overnight masscut\\"
...
#                p.remove_neigbour(nID)
    ...
    sumDist = np.sum(distancesList)
    distancesList=[dist for dist in distancesList]
    plt.hist(distancesList, bins = 60, label= "Time "+ str(round(item*10/60.0,1)) + " hours")
