...
#plt.scatter(xlist,list2, label = "2 neigbours", c=colour[1], marker = filled_markers[1])
plt.scatter(xlist,list3, label = "3 neigbours", c='b', marker = filled_markers[2])
plt.scatter(xlist,list4, label = "4 neigbours", c='r', marker = filled_markers[3])
plt.scatter(xlist,list5, label = "5 neigbours", c='g', marker = filled_markers[4])
...
plt.title("Neighbours in time")
plt.ylabel("precentage of particles with # amount of neibours")
